...
/*Realizado por Andrés Crespo. "Ponche Crema". 
C.I- 31.259.533*/
...
void julielederman();
void timcheatham();
void comparadorvictsteve();
void comparadorvictjulie();
void comparadorvicttim();
void controundsperdyganados();
void resultadofinal();
void decisionfinal();
void comparadortarjetas();
void pagobox();
